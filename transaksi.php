...
<html>
<head>
<link rel="stylesheet" type="text/css" href="transaksis.css">
</head>
<body>
            ...
            <table>
                <form action="" method="POST">
                    ...
                    <tr>
                        <td>Jumlah Produk</td>
                        <td> : </td>
                        <td><input type="text" name="tambahan" value="" placeholder=""></td>
                    </tr>
                    <tr>
                        <td class="button">
    ...
    <div class="container555">
        ...
        <form action="" method="POST">
                    <tr>
                        <td>Total Harga</td>
                        <td> : </td>
                        <td><input type="text" value="<?= $total ?>"name="totalbayar" placeholder=""></td>
                        <td><?php echo"<br>"?><td>
                    ...
                    <tr>
                        ...
                        <td><?php echo"<br>"?><td>
                        <td class="buttonss">
	<center><a class="buttonss" href="#popup1">Simpan Transaksi</a>
</td>
</div>
...
<div id="popup1" class="overlay">
	<div class="popup">
        ...
        <div class="buttons">
        <center><a class="buttons" href="home.php">OK</a>
</div>
	</div>
</div>
</td>
